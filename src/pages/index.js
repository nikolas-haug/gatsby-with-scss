  ...
  return (
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-med-3 col-lg-4">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque provident explicabo earum dolores! Facilis beatae, id eum consequuntur commodi cumque amet, quia corrupti suscipit minus quidem, soluta numquam harum possimus.</p>
        </div>
        <div className="col-med-3 col-lg-4">
